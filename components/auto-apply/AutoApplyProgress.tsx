  ...
  return (
    <div className={`rounded-xl border p-3 sm:p-4 ${
      ...
      <div className="flex items-start sm:items-center gap-3">
        {isActive && <Loader2 className="h-5 w-5 shrink-0 animate-spin text-blue-600" />}
        {isDone && <CheckCircle className="h-5 w-5 shrink-0 text-green-600" />}
        {isFailed && <AlertCircle className="h-5 w-5 shrink-0 text-red-600" />}
