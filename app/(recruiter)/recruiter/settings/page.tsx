...
export default function RecruiterSettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-lg space-y-8">
      ...
      <div>
        <h2 className="mb-2 text-lg font-semibold text-text">Switch Role</h2>
        <button onClick={switchToJobSeeker}
          className="flex items-center gap-2 rounded-lg border border-gray-300 px-4 py-2 text-sm text-text hover:bg-gray-50">
