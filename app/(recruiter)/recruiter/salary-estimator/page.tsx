...
export default function SalaryEstimatorPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <h1 className="text-2xl font-bold text-text">AI Salary Estimator</h1>
      ...
      <form onSubmit={handleEstimate} className="space-y-4 rounded-xl border border-gray-200 bg-card p-5">
        <div>
      ...
      {result && (
        <div className="space-y-4">
          <div className="rounded-xl border border-gray-200 bg-card p-6">
            <h3 className="mb-4 text-sm font-semibold text-text">Salary Range ({result.currency})</h3>
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="text-center">
                <p className="text-xs text-text-muted">Minimum</p>
                <p className="text-2xl font-bold text-text">₹{formatSalary(result.min)}</p>
              </div>
              <div className="text-center">
                <p className="text-xs text-text-muted">Median</p>
                <p className="text-2xl font-bold text-primary">₹{formatSalary(result.median)}</p>
              </div>
              <div className="text-center">
                <p className="text-xs text-text-muted">Maximum</p>
                <p className="text-2xl font-bold text-text">₹{formatSalary(result.max)}</p>
              </div>
            </div>
